...
DCA-CC grants you a revocable, non-exclusive, non- transferable, limited license to download, install and use our service strictly in accordance with the terms of this Agreement.

These Terms & Conditions are a contract between you and DCA-CC (referred to in these Terms & Conditions as "DCA-CC", "us", "we" or "our"), the provider of the DCA-CC website and the services accessible from the DCA-CC website (which are collectively referred to in these Terms & Conditions as the "DCA-CC Service").
