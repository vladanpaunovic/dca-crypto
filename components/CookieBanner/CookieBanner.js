...
const CookieBanner = () => {
  ...
  return (
    isShown && (
      <>
        <div className="border-t dark:border-gray-700 bg-white dark:bg-gray-900 fixed bottom-0 left-0 right-0 z-20">
          <div className="py-8 px-4 sm:px-6 lg:px-8">
            <div className="flex items-center justify-between flex-wrap">
              <div className="flex items-start">
                <span className="hidden sm:flex p-2 rounded-lg  fill-current text-indigo-500 dark:text-yellow-500 mr-4">
                  <svg
              ...
              <div className="flex mt-8 sm:mt-0 w-full sm:w-auto">
                <button
                  onClick={handleOnAccept}
                  className="flex w-full items-center justify-center px-4 py-2 border border-indigo-500 dark:border-yellow-500 rounded-md shadow-sm text-sm font-medium text-indigo-600 dark:text-yellow-500 hover:bg-indigo-500 hover:text-white dark:hover:bg-yellow-500 dark:hover:text-gray-900"
                >
                  I accept
                </button>
              </div>
