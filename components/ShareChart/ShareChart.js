...
const SharingButtons = () => {
  ...
  const socialNetworks = [
    ...
    {
      label: "Facebook",
      href: `https://facebook.com/sharer/sharer.php?u=${locationHref}`,
      color: "#3b5998",
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" className="w-6 h-6">
...

    {
      label: "Reddit",
      color: "#5f99cf",
      href: `https://reddit.com/submit/?url=${locationHref};resubmit=true&amp;title=${subject}`,
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" className="w-6 h-6">
    ...
    },
    {
      label: "Pinterest",
      color: "#bd081c",
      href: `https://pinterest.com/pin/create/button/?url=${locationHref};description=${priceChartMessage}`,
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" className="w-6 h-6">
...

    {
      label: "Linkedin",
      color: "#0077b5",
      href: `https://www.linkedin.com/shareArticle?mini=true&amp;url=${locationHref};title=${subject};summary=${priceChartMessage}`,
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" className="w-6 h-6">
    ...
    },
    {
      label: "WhatsApp",
      color: "#25D366",
      href: `whatsapp://send?text=${priceChartMessage}. ${locationHref}`,
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" className="w-6 h-6">
