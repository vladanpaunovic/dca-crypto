...
const SharingButtons = ({ currentCoin, currentUrl }) => {
  ...
  const socialNetworks = [
...

    {
      label: "Reddit",
      color: "#5f99cf",
      href: `https://reddit.com/submit?url=${currentUrl}&title=${subject}`,
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" className="w-6 h-6">
...

    {
      label: "Telegram",
      color: "#54A9EB",
      href: `https://telegram.me/share/url?text=${priceChartMessage}&url=${currentUrl}`,
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" className="w-6 h-6">
...

    {
      label: "E-Mail",
      color: "#777",
      href: `mailto:?subject=${subject};body=${priceChartMessage} - ${currentUrl}`,
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" className="w-6 h-6">
...
const CurrentUrl = ({ currentCoin, currentUrl }) => {
