...
const ErrorComponent = ({ error }) => {
  return (
    <div className="bg-indigo-200 dark:bg-indigo-600 rounded-lg">
      <div className="py-6 px-3 sm:px-6 lg:px-6 ">
        <div className="flex flex-wrap flex-col md:flex-row items-center justify-between">
          <div className="flex md:w-0 flex-1 items-center">
            <span className="flex rounded-lg bg-indigo-400 dark:bg-indigo-900 p-2">
              <ExclamationIcon
                className="h-6 w-6 text-indigo-900 dark:text-indigo-400"
                aria-hidden="true"
              />
            </span>
